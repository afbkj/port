                        ...
                        <div>
                            ...
                            <div className="space-y-3">
                                <a 
                                    ...
                                    className='groud flex items-center gap-3 p-3 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 hover:border-primary/30 transition-all duration-300'
                                >
