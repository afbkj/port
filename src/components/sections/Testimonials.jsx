    ...
    return (
        <section id='testimonials' className='relative py-20 bg-black overflow-hidden'>
            <div className='absolute inset-0 overflow-hidden'>
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translte-y-1/2 w-96 h-96 bg-primary/10 opacity-90 rounded-full blur-3xl" />
            </div>
                ...
                <FadeIn delay={0}>
                    <div className="text-center mb-16">
                        ...
                        <p className="text-lg text-white/60 max-w-xl mx-auto ">
                            Empowering clients with design-driven
                        </p>
                    </div>
                </FadeIn>
                ...
                <FadeIn delay={100}>
                    <div className="relative">
                        ...
                        <button 
                            ...
                            className='flex bsolute left-0 top-1/2 -translate-y-1/2 -translate-x-2 lg:-translate-x-4 items-center justify-center w-10 h-10 lg:w-12 lg:h-12 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full hover:bg-white/20 transition-all duration-300 z-10'
