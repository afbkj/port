                        ...
                        <FadeIn delay={200}>
                            <div className='grid grid-cols-2 gap-4'>
                                <div className='col-span-2 relative group'>
                                    <div className='absolute inset-0 bg-linear-to-br from-primary to-primary/5 rounded-2xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity duration-300'></div>
                                        ...
                                        <div className='flex items-start gap-4'>
                                            ...
                                            <div className='flex-1'>
                                                ...
                                                <p className='text-sm text-white/70 leading-relaxed'>
                                                    Specialized in building scalable web or something...
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className='relative group'>
                                    <div className='absolute inset-0 bg-linear-br from-primary/10 to-primary/5 rounded-2xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity duration-300'></div>
                                    <div className='relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 h-full'>
                                        <div className='p-e bg-primary/10 rounded-xl w-fit mb-4'>
                                ...
                                <div className='relative group'>
                                    ...
                                    <div className='relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 h-full'>
                                        ...
                                        <p className='text-sm text-white/70 leading-relaxed'>
                                            Optimizing for speed an efficiency
                                        </p>
                                    </div>
                                </div>
                                    ...
                                    <div className='relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300'>
                                        <div className='grid grid-cols-3 gap-6 text-center'>
                                            <div>
                                                ...
                                                <div className='text-xs text-white/60'>Client satisfction</div>
                                            </div>
                                            <div>
