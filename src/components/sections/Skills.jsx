                    ...
                    {Object.entries(skillCategories).map(([category, categorySkills], categoryIndex)=>(
                        <FadeIn key={category} delay={categoryIndex * 100}>
                            <div className='relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 group'>
                                ...
                                {/* Hover Glow Effect */}
                                <div className='absolute inset-0 bg-linear-to-br from-primary/0 to-primary/5 group-hover:from-primary/5 rounded-2xl transition-all duration-300 pointer-events-none'></div>
                            </div>
                        </FadeIn>
                    ))}
                </div>
